...
if __name__ == "__main__":
    ...
    parser.add_argument("--logdir", type=str, default="logs/after198", help="Defines the directory where the training log files are stored")
    ...
    os.makedirs("checkpoints/after198", exist_ok=True)
    ...
    for epoch in range(opt.epochs):
        ...
        if epoch % opt.checkpoint_interval == 0:
            torch.save(model.state_dict(), f"checkpoints/after198/yolov3_ckpt_%d.pth" % epoch)
